        ...
        <DialogHeader>
          ...
          <DialogDescription asChild>
            <div className="mt-5">
              ...
              <div
                className={`p-5 mt-8 rounded-md flex justify-between items-center ${feedback?.recommendation === "No"
                    ? "bg-red-300"
                    : "bg-green-300"
                  }`}
              >
                <div>
                  ...
                  <p
                    className={`select-none ${feedback?.Recommendation === "No"
                        ? "text-red-500"
                        : "text-green-700"
                      }`}
                  >
                ...
                <div className="flex flex-col items-center">
                  {/* REPLACED LINK WITH NEW COMPONENT */}
